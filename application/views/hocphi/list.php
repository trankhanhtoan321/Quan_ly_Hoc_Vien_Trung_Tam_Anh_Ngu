...
<table class="table table-striped table-bordered">
	...
	{
		?>
		<tr <?php if(!$hocphis[$i]['HP_TIENDONG']) echo "class=\"danger\""; else if($hocphis[$i]['KH_HOCPHI']==$hocphis[$i]['HP_TIENDONG']); else echo "class=\"info\""; ?>>
...
<a class="btn btn-warning" href="/hocphi/report/0">Xuất File Excel</a>
<script>
function canhbao()
{
